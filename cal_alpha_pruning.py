...
def get_result(_metro, in_start, in_end, in_alpha):
    ...
    alpha_candidate_paths = find_all_paths_alpha(_metro.graph.cost_matrix, in_start, in_end, threshold)
    ...
    output = []
    spsp = []
    spsp.append([alpha_candidate_paths, 0])
    for p in alpha_candidate_paths:
